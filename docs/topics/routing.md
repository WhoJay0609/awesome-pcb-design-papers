...
### A-star Algorithm-Based Automated Routing for Multilayer PCB

- **Metadata:** 2026 · Applied Power Electronics Conference · Chanhee Park, K. Kim, Jeongwoo Son, Gyunghoon Park, Seung-Hwan Lee · [paper](https://doi.org/10.1109/apec51134.2026.11516836)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `benchmarks-tools`
...
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2026 · Expert Systems with Applications · Yin-Chi Liao, Sheng-Xin Pan, Po-Jui Chiang · [paper](https://doi.org/10.1016/j.eswa.2026.131424)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`, `benchmarks-tools`
- **Code:** [open](https://github.com/yinqimakeitfun/dreamer-Autorouting/tree/main): Publishes Dreamer autorouting and FreeRouting integration code.
- **Dataset or data source:** `reported`: FreeRouting environment
- **Application scenario:** Uses world-model RL to drive FreeRouting for end-to-end PCB autorouting.
...
- **Metadata:** 2026 · ACM Trans. Design Autom. Electr. Syst. · Jia-Chu Lin, Longkun Guo, Weijie Fang · [paper](https://doi.org/10.1145/3795795)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
...
- **Metadata:** 2026 · ACM Trans. Design Autom. Electr. Syst. · Jianxuan Yu, Zhe Gao, Sheqin Dong, Zuochang Ye, Wenjian Yu · [paper](https://doi.org/10.1145/3795522)
...
- **Metadata:** 2026 · arXiv · Taiting Lu, Kaiyuan Lin, Ziwei Dong, Sisong Bei, Haolin Ye, Mahanth Gowda · [paper](https://arxiv.org/abs/2608.04434)
- **Scope and topics:** `pcb-core` · `routing`, `schematic-design`, `benchmarks-tools`, `ai-eda`
- **Code:** announced: The paper announces an open benchmark, evaluation code, and tool interfaces, but no stable release URL was verified by the cutoff date.
- **Dataset or data source:** `announced`: OmniRouting
- **Application scenario:** LMMs and agents generate PCB traces, vias, and layer assignments under design-rule, manufacturing, and electrical constraints.
...
- **Metadata:** 2026 · IEEE transactions on consumer electronics · Hyun-Ho Bae, Jong-Moon Chung · [paper](https://doi.org/10.1109/tce.2026.3719339)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `thermal-reliability`
...
- **Metadata:** 2026 · IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems · Hao-Yun Chang, Yao-Wen Chang · [paper](https://doi.org/10.1109/tcad.2025.3596537)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
...
- **Metadata:** 2026 · 2026 6th International Conference on Electronics, Circuits and Information Engineering (ECIE) · Senru Cheng, Qinghai Liu · [paper](https://doi.org/10.1109/ecie69549.2026.11565623)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `reported_in_abstract`: The abstract mentions a dataset, benchmark, or real, industrial, or simulated data; only names that can be identified are retained.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2025 · IEEE Access · Youbiao He, Hebi Li, Ge Luo, F. Bao · [paper](https://doi.org/10.1109/access.2024.3386921)
- **Scope and topics:** `pcb-core` · `routing`, `testing-inspection`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
...
- **Metadata:** 2025 · IEEE Transactions on Components, Packaging and Manufacturing Technology · Jin-Tai Yan · [paper](https://doi.org/10.1109/TCPMT.2025.3558532)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code was verified.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata do not report a dataset.
- **Application scenario:** Bus-aware ordered escape routing under bus-direction constraints.
...
- **Metadata:** 2025 · IEEE TCAD 44(4) · Jienan Chen, Jun Tu, Hao Wang, Jie Zheng, Hao Liu, Shenglong Bai, Xiantuo He, Weikang Qian · [paper](https://doi.org/10.1109/tcad.2024.3486241)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`
- **Code:** not_found: No public implementation was verified.
- **Dataset or data source:** `not_reported_in_accessible_source`: Encodes human routing information as network-flow tokens; public sources do not give the corpus size.
- **Application scenario:** Uses a generative pretrained transformer to predict PCB routing tokens in parallel.
...
- **Metadata:** 2025 · DATE 2025 · Haiyun Li, Jixin Zhang · [paper](https://doi.org/10.23919/date64628.2025.10993225)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public implementation was verified.
- **Dataset or data source:** `private_or_unreleased`: Xilinx Zynq XC7Z030, AF Motor, STM32F767
- **Application scenario:** Large-scale general PCB routing with thousands of nets, complex obstacles, and DRC constraints.
...
- **Metadata:** 2025 · Integr. · Jianhao Cao, Hao Cai, Ning Xu · [paper](https://doi.org/10.1016/j.vlsi.2025.102533)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2025 · International Journal of High Speed Electronics and Systems · Yongxing Wang · [paper](https://doi.org/10.1142/s0129156425405777)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `thermal-reliability`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2025 · 2025 IEEE/ACM International Conference On Computer Aided Design (ICCAD) · Taejin Paik, Jaemin Park, Taehee Kim, Daniel Hyunsuk Jung, Doyun Kim · [paper](https://doi.org/10.1109/iccad66269.2025.11240981)
- **Scope and topics:** `pcb-core` · `routing`
...
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ICCAD DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2024 · Latin American Conference on Computational Intelligence · H. T. Azambuja, N. Nedjah, L. M. Mourelle · [paper](https://doi.org/10.1109/la-cci62337.2024.10814812)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `testing-inspection`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
...
- **Metadata:** 2024 · Proceedings of the 61st ACM/IEEE Design Automation Conference · Wei-Che Tseng, Zong-Ying Cai, Yi-Ping Huang, Yu-Hsiang Lo, Yao-Wen Chang · [paper](https://doi.org/10.1145/3649329.3663494)
...
- **Metadata:** 2024 · 2024 IEEE 33rd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Katharina Scharff, Xiaomin Duan, Dierk Kaller · [paper](https://doi.org/10.1109/epeps61853.2024.10754337)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
...
- **Metadata:** 2024 · ACM TODAES · Zhenyi Gao, Sheqin Dong, Zhicong Tang, Wenjian Yu · [paper](https://doi.org/10.1145/3695253)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was verified.
- **Dataset or data source:** `benchmark_cases`: grid and staggered pin arrays
- **Application scenario:** Multi-capacity ordered escape routing for high-density pin arrays.
...
- **Metadata:** 2024 · ISQED 2024 · Zhenyi Gao, Sheqin Dong, Zifei Cheng, Wenjian Yu · [paper](https://doi.org/10.1109/ISQED60706.2024.10528693)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was verified.
- **Dataset or data source:** `benchmark_cases`: 9 pin-array cases
- **Application scenario:** Multilayer multi-capacity ordered escape routing.
...
- **Metadata:** 2024 · Design Automation Conference · Weijie Fang, Longkun Guo, Jia-Chu Lin, Silu Xiong, Huan He, Jiacen Xu, Jianli Chen · [paper](https://doi.org/10.1145/3649329.3655915)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2024 · 2024 2nd International Symposium of Electronics Design Automation (ISEDA) · Hao Wang, Jun Tu, Shenglong Bai, Jie Zheng, Weikang Qian, Jienan Chen · [paper](https://doi.org/10.1109/iseda62518.2024.10617906)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2024 · Proceedings of the 61st ACM/IEEE Design Automation Conference · Doyun Kim, Jaemin Park, Youngmin Oh, Bosun Hwang · [paper](https://doi.org/10.1145/3649329.3658484)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`, `ai-eda`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2024 · Integr. · Disi Lin, Chuandong Chen, Rongshan Wei, Qinghai Liu, Huan He, Ziran Zhu, Zhifeng Lin, Jianli Chen · [paper](https://doi.org/10.1016/j.vlsi.2024.102270)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2023 · 2023 IEEE 32nd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Srijan Datta, Yuechen Wang, Junyan Tang, Xianbo Yang, Yanyan Zhang, Pavel R. Paladhi, Mahesh Bohra, Joshua C. Myers, et al. · [paper](https://doi.org/10.1109/epeps58208.2023.10314873)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2023 · DAC 2023 · Qinghai Liu, Qinfei Tang, Jiarui Chen, Chuandong Chen, Ziran Zhu, Huan He, Jianli Chen, Yao-Wen Chang · [paper](https://doi.org/10.1109/dac56929.2023.10247728)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was verified.
- **Dataset or data source:** `benchmark_cases`: irregular PCB routing cases
- **Application scenario:** Irregular PCB escape and bus routing under complex constraints.
...
- **Metadata:** 2023 · 2023 IEEE 73rd Electronic Components and Technology Conference (ECTC) · Zhaoqing Chen, Hung Nguyen, Matteo Cocchini · [paper](https://doi.org/10.1109/ectc51909.2023.00310)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
...
- **Metadata:** 2023 · AAAI 2023 · Haiyun Li, Jixin Zhang, Ning Xu, Mingyu Liu · [paper](https://doi.org/10.1609/aaai.v37i7.26030)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`
- **Code:** not_found: No public code repository was verified.
- **Dataset or data source:** `private_or_unreleased`: industrial PCB benchmarks
- **Application scenario:** Fanout automation before global routing on dense multilayer PCBs.
...
- **Metadata:** 2023 · ISQED 2023 · Zhenyi Gao, Sheqin Dong, Zhicong Tang, Wenjian Yu · [paper](https://doi.org/10.1109/ISQED57927.2023.10129354)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was verified.
- **Dataset or data source:** `benchmark_cases`: grid pin arrays
- **Application scenario:** Multi-capacity ordered escape routing.
...
- **Metadata:** 2023 · 2023 IEEE 32nd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Alex Manukovsky, Yuriy Shlepnev, Shimon Mordooch · [paper](https://doi.org/10.1109/epeps58208.2023.10314936)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2023 · Design, Automation and Test in Europe · Youbiao He, Hebi Li, Ge Luo, F. Bao · [paper](https://doi.org/10.23919/date56975.2023.10137062)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2023 · IEEE Access · Shiyuan Yin, Min Jin, Gang Chen, Guoliang Gong, Wenyu Mao, Huaxiang Lu · [paper](https://doi.org/10.1109/access.2023.3323589)
- **Scope and topics:** `pcb-core` · `routing`, `ai-eda`
- **Code:** [open](https://github.com/Firesuiry/Unet-Astar-For-PCB-Routing): The authors' repository provides training, inference, and routing code.
- **Dataset or data source:** `generated`: Unet-Astar generated routing problems
- **Application scenario:** Unified PCB routing covering both BGA and non-BGA components.
...
- **Metadata:** 2021 · Design Automation Conference · Shih-Ting Lin, Hung-Hsiao Wang, Chia-Yu Kuo, Yolo Chen, Yih-Lang Li · [paper](https://doi.org/10.1109/dac18074.2021.9586143)
- **Scope and topics:** `pcb-core` · `routing`, `testing-inspection`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** Routing and constraint handling.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
...
- **Metadata:** 2021 · Proceedings of the 26th Asia and South Pacific Design Automation Conference · Ting-Chou Lin, Devon Merrill, Yen-Yi Wu, Chester Holtz, Chung-Kuan Cheng · [paper](https://doi.org/10.1145/3394885.3431568)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
...
- **Metadata:** 2021 · 2021 IEEE 30th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Junyan Tang, Xianbo Yang, Jose A. Hejase, Mahesh Bohra, Yanyan Zhang, Xiaomin Duan, Dierk Kaller, Wiren D. Becker, et al. · [paper](https://doi.org/10.1109/epeps51341.2021.9609151)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2021 · 2021 IEEE 30th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Jay Reddy, James Mobley, Doug Wallace, James Pingenot, Daniel de Araujo, Cristian Filip, Swagato Chakraborty, Chuck Ferry, et al. · [paper](https://doi.org/10.1109/epeps51341.2021.9609174)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`, `ai-eda`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2021 · 2021 58th ACM/IEEE Design Automation Conference (DAC) · Rassul Bairamkulov, Abinash Roy, Mali Nagarajan, Vaishnav Srinivas, Eby G. Friedman · [paper](https://doi.org/10.1109/dac18074.2021.9586128)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2020 · 2020 IEEE 29th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Armen Vardapetyan, Chong-Jin Ong · [paper](https://doi.org/10.1109/epeps48591.2020.9231314)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2019 · 2019 IEEE 28th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Kaisheng Hu · [paper](https://doi.org/10.1109/epeps47316.2019.193206)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2019 · 2019 IEEE 28th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Alex Manukovsky, Yuriy Shlepnev · [paper](https://doi.org/10.1109/epeps47316.2019.193228)
- **Scope and topics:** `pcb-core` · `routing`, `dfm-manufacturing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
- **Problem addressed:** `inferred_from_title`: The paper addresses the PCB or board-level task described by its title. The precise problem boundary requires the full paper.
...
- **Metadata:** 2019 · 2019 IEEE 28th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Sunil Pathania, Mallikarjun Vasa, Bhyrav Mutnury, Rohit Sharma · [paper](https://doi.org/10.1109/epeps47316.2019.193226)
- **Scope and topics:** `pcb-core` · `routing`, `thermal-reliability`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
- **Problem addressed:** `inferred_from_title`: The paper addresses the PCB or board-level task described by its title. The precise problem boundary requires the full paper.
...
- **Metadata:** 2018 · 2018 IEEE 27th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Yanyan Zhang, Jose A. Hejase, Joshua C. Myers, Jean J. Audet, Wiren D. Becker, Daniel M. Dreps · [paper](https://doi.org/10.1109/epeps.2018.8534304)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2018 · 2018 IEEE 27th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Junyan Tang, Jose A. Hejase, Pavel RoyPaladhi, Wiren D. Beckir, Daniel M. Dreps · [paper](https://doi.org/10.1109/epeps.2018.8534241)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2018 · 2018 IEEE 27th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Chien-Chang Huang, Yu-Ching Chen, Chen-Yu Liao, Wen-Chieh Huang · [paper](https://doi.org/10.1109/epeps.2018.8534259)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2018 · 2018 IEEE 27th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · Biyao Zhao, Zhaoqing Chen, Dale Becker · [paper](https://doi.org/10.1109/epeps.2018.8534295)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2018 · 2018 IEEE 68th Electronic Components and Technology Conference (ECTC) · Zhaoqing Chen · [paper](https://doi.org/10.1109/ectc.2018.00271)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2017 · 2017 IEEE 26th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · David Nozadze, Amendra Koul, Kartheek Nalla, Mike Sapozhnikov, Victor Khilkevich · [paper](https://doi.org/10.1109/epeps.2017.8329757)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2017 · 2017 IEEE 67th Electronic Components and Technology Conference (ECTC) · Kaiqiang Peng, Wei Xu, Zhenkai Qin, Lei Feng, Linlin Lai, Wei Koh · [paper](https://doi.org/10.1109/ectc.2017.281)
- **Scope and topics:** `pcb-core` · `routing`, `thermal-reliability`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2015 · Asia and South Pacific Design Automation Conference · Ran Zhang, Tieyuan Pan, Li Zhu, Takahiro Watanabe · [paper](https://doi.org/10.1109/aspdac.2015.7059038)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2015 · 2015 IEEE 24th Electrical Performance of Electronic Packaging and Systems (EPEPS) · Cong Gao, Pravin Patel · [paper](https://doi.org/10.1109/epeps.2015.7347154)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2014 · 2014 IEEE 64th Electronic Components and Technology Conference (ECTC) · Yujeong Shim, Dan Oh · [paper](https://doi.org/10.1109/ectc.2014.6897560)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2013 · 2013 IEEE/ACM International Conference on Computer-Aided Design (ICCAD) · Tsun-Ming Tseng, Bing Li, Tsung-Yi Ho, Ulf Schlichtmann · [paper](https://doi.org/10.1109/iccad.2013.6691193)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ICCAD DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2012 · 2012 IEEE 21st Conference on Electrical Performance of Electronic Packaging and Systems · Lisha Zhang, George Pan, Zhonghai Guo · [paper](https://doi.org/10.1109/epeps.2012.6457904)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2011 · 16th Asia and South Pacific Design Automation Conference (ASP-DAC 2011) · Qiang Ma, Hui Kong, Martin D. F. Wong, Evangeline F. Y. Young · [paper](https://doi.org/10.1109/aspdac.2011.5722308)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2011 · 2011 IEEE/ACM International Conference on Computer-Aided Design (ICCAD) · Yuan-Kai Ho, Hsu-Chieh Lee, Yao-Wen Chang · [paper](https://doi.org/10.1109/iccad.2011.6105346)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2011 · 2011 IEEE 61st Electronic Components and Technology Conference (ECTC) · Jung Kyu Park, Young Ki Lee, Seung Hwan Choi, Sang Hyun Shin, Myoung Soo Choi · [paper](https://doi.org/10.1109/ectc.2011.5898755)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2011 · 2011 IEEE 61st Electronic Components and Technology Conference (ECTC) · Kyung-Woon Jang, Chang-Kyu Chung, Jiyoung Jang, Soon-Min Hong, Min-Young Park, Youngjun Moon, Seungbae Park · [paper](https://doi.org/10.1109/ectc.2011.5898739)
- **Scope and topics:** `pcb-core` · `routing`, `dfm-manufacturing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2011 · 2011 IEEE 61st Electronic Components and Technology Conference (ECTC) · Yan Ding, Young H. Kwark, Lei Shan, Christian Baks, Ke Wu · [paper](https://doi.org/10.1109/ectc.2011.5898552)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2010 · Design Automation Conference · Hui Kong, Qiang Ma, Tan Yan, Martin D. F. Wong · [paper](https://doi.org/10.1145/1837274.1837326)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2010 · ISPD 2010 · Lijuan Luo, Tan Yan, Qiang Ma, Martin D. F. Wong, Toshiyuki Shibuya · [paper](https://doi.org/10.1145/1735023.1735033)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code release was verified.
- **Dataset or data source:** `industrial_cases`: industrial escape-routing problems
- **Application scenario:** Dense PCB simultaneous escape routing.
...
- **Metadata:** 2009 · 2009 IEEE 18th Conference on Electrical Performance of Electronic Packaging and Systems · Kai-Bin Wu, Fu-Sheng Chang, Ruey-Beei Wu · [paper](https://doi.org/10.1109/epeps.2009.5338430)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2009 · 2009 IEEE 18th Conference on Electrical Performance of Electronic Packaging and Systems · Juyoung Lee, Drew Doblar · [paper](https://doi.org/10.1109/epeps.2009.5338491)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2009 · Proceedings of the 46th Annual Design Automation Conference · Jia-Wei Fang, Martin D. F. Wong, Yao-Wen Chang · [paper](https://doi.org/10.1145/1629911.1630002)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2008 · 2008 Design, Automation and Test in Europe · Renato Rimolo-Donadio, Christian Schuster, Xiaoxiong Gu, Young H. Kwark, Mark B. Ritter · [paper](https://doi.org/10.1109/date.2008.4484891)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DATE DOI record; it is not treated as an experimental finding.
- **Problem addressed:** `inferred_from_title`: The paper addresses the PCB or board-level task described by its title. The precise problem boundary requires the full paper.
- **Final evaluation:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report final tests, metrics, or numerical results. Metrics: not explicitly listed in the accessible sources.
- **Baselines:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not list a baseline.
- **Evidence boundary:** `metadata-only`; checked on 2026-08-11. Not reported does not mean absent.
...
- **Metadata:** 2008 · 2008 IEEE-EPEP Electrical Performance of Electronic Packaging · Mosin Mondal, Samuel Connor, Bruce Archambeault, Vikram Jandhyala · [paper](https://doi.org/10.1109/epep.2008.4675907)
- **Scope and topics:** `pcb-core` · `routing`, `si-pi-emc`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2007 · 2007 IEEE Electrical Performance of Electronic Packaging · Kaiyu Mao, Jilin Tan, Jian-Ming Jin · [paper](https://doi.org/10.1109/epep.2007.4387181)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the EPEPS DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 2004 · IEEE/ACM International Conference on Computer Aided Design, 2004. ICCAD-2004. · Muhammet Mustafa Ozdal, Martin D. F. Wong · [paper](https://doi.org/10.1109/iccad.2004.1382689)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 2003 · ICCAD-2003. International Conference on Computer Aided Design (IEEE Cat. No.03CH37486) · M.M. Ozdal, M.D.F. Wong · [paper](https://doi.org/10.1109/iccad.2003.159717)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ICCAD DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1998 · Proceedings 1998 Design and Automation Conference. 35th DAC. (Cat. No.98CH36175) · J. Cong, P.H. Madden · [paper](https://doi.org/10.1109/dac.1998.724497)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1995 · 32nd Design Automation Conference · Wai-Kei Mak · [paper](https://doi.org/10.1109/dac.1995.250008)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1995 · 32nd Design Automation Conference · Sharad Mehrotra · [paper](https://doi.org/10.1109/dac.1995.249977)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1991 · Proceedings of the 28th conference on ACM/IEEE design automation conference  - DAC '91 · Sung-Chuan Fang, Kuo-En Chang, Wu-Shiung Feng, Sao-Jie Chen · [paper](https://doi.org/10.1145/127601.127629)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1991 · Proceedings of the 28th conference on ACM/IEEE design automation conference  - DAC '91 · Heinz Mattes, Wolfgang Weisenseel, Gerhard Bischof, Reimund Dachauer · [paper](https://doi.org/10.1145/127601.127734)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1988 · 25th ACM/IEEE, Design Automation Conference.Proceedings 1988. · X. Xiong, E. Kuh · [paper](https://doi.org/10.1109/dac.1988.14818)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1987 · 24th ACM/IEEE conference proceedings on Design automation conference  - DAC '87 · E. Rosenberg · [paper](https://doi.org/10.1145/37888.38003)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1987 · 24th ACM/IEEE Design Automation Conference · Jeremy Dion · [paper](https://doi.org/10.1145/37888.38004)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1986 · 23rd ACM/IEEE Design Automation Conference · J.F. Naveda, K.C. Chang, H.C. Du · [paper](https://doi.org/10.1109/dac.1986.1586166)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1986 · 23rd ACM/IEEE Design Automation Conference · T. Tada, A. Hanafusa · [paper](https://doi.org/10.1109/dac.1986.1586179)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1985 · 22nd ACM/IEEE Design Automation Conference · A.C. Finch, K.J. Mackenzie, G.J. Balsdon, G. Symonds · [paper](https://doi.org/10.1109/dac.1985.1585990)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1985 · Proceedings of the 22nd ACM/IEEE conference on Design automation  - DAC '85 · Robert Leo'nard' Joseph · [paper](https://doi.org/10.1145/317825.317939)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1981 · Design Automation Conference · R. Tsui, Robert J. Smith · [paper](https://doi.org/10.1109/dac.1981.1585384)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1981 · 18th Design Automation Conference · S. Aranoff, Y. Abulaffio · [paper](https://doi.org/10.1109/dac.1981.1585343)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1980 · Proceedings of the seventeenth design automation conference on Design automation  - DAC '80 · Ikuo Nishioka, Takuji Kurimoto, Hisao Nishida, Seiji Yamamoto, Toru Chiba, Toshiaki Nagakawa, Takatsugu Fujioka, Masashi Uchino · [paper](https://doi.org/10.1145/800139.804580)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1980 · Proceedings of the seventeenth design automation conference on Design automation  - DAC '80 · Michael J. Lorenzetti, Robert J. Smith · [paper](https://doi.org/10.1145/800139.804536)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1979 · 16th Design Automation Conference · J.C. Foster · [paper](https://doi.org/10.1109/dac.1979.1600155)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1979 · Design Automation Conference · Lawrence Dysart, M. Koifman · [paper](https://doi.org/10.1109/dac.1979.1600156)
- **Scope and topics:** `pcb-core` · `routing`, `benchmarks-tools`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1979 · 16th Design Automation Conference · S. Pimont · [paper](https://doi.org/10.1109/dac.1979.1600154)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1978 · 15th Design Automation Conference · R.S. Fisher · [paper](https://doi.org/10.1109/dac.1978.1585152)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1978 · Design Automation Conference · Leah Mory-Rauch · [paper](https://doi.org/10.1109/dac.1978.1585150)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** Routing and constraint handling.
...
- **Metadata:** 1976 · The proceedings of the thirteenth design automation conference on Design automation  - DAC '76, NO. 13 · Barry D. Heller, Robert S. Fisher · [paper](https://doi.org/10.1145/800146.804810)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1972 · Proceedings of the ninth design automation workshop on Design automation  - DAC '72 · Norman L. Koren · [paper](https://doi.org/10.1145/800153.804932)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1972 · Proceedings of the ninth design automation workshop on Design automation  - DAC '72 · L. Mah, L. Steinberg · [paper](https://doi.org/10.1145/800153.804933)
- **Scope and topics:** `pcb-core` · `routing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the DAC DOI record; it is not treated as an experimental finding.
