...
|---:|---|---|---|---|
| 2026 | [Automatic PCB Component Placement via GNN-Guided Similarity Retrieval Coupled with GAN-Based Completion](#automatic-pcb-component-placement-via-gnn-guided-similarity-retrieval-coupled-with-gan-based-completion) | 2026 International Conference on Electronics Packaging and Hybrid Bonding Symposium (ICEP-HBS) | not found | abstract |
| 2026 | [Component Centric Placement Using Deep Reinforcement Learning](#component-centric-placement-using-deep-reinforcement-learning) | arXiv | not found | full-text |
...
| 2025 | [An analytical approach and fine-tuning strategy for PCB placement optimization](#an-analytical-approach-and-fine-tuning-strategy-for-pcb-placement-optimization) | Integr. | not found | metadata-only |
| 2025 | [Clearance-Constrained PCB Global Placement with Heterogeneous Components](#clearance-constrained-pcb-global-placement-with-heterogeneous-components) | Design Automation Conference · **DAC** | not found | abstract |
| 2025 | [Constraint Graph-based PCB Legalization Considering Dense, Heterogeneous, Irregular-Shaped, and Any-oriented Components](#constraint-graph-based-pcb-legalization-considering-dense-heterogeneous-irregular-shaped-and-any-oriented-components) | 2025 62nd ACM/IEEE Design Automation Conference (DAC) · **DAC** | not reported | metadata-only |
| 2025 | [Cypress: VLSI-Inspired PCB Placement with GPU Acceleration](#cypress-vlsi-inspired-pcb-placement-with-gpu-acceleration) | ISPD 2025 · **ISPD** | open | project-page |
| 2025 | [Graph-based legalization for PCB placement](#graph-based-legalization-for-pcb-placement) | Journal of Physics, Conference Series | not found | abstract |
| 2025 | [Late Breaking Results: Advanced PCB Placement with Irregular Components for Efficient Collision Detection and Routability Optimization](#late-breaking-results-advanced-pcb-placement-with-irregular-components-for-efficient-collision-detection-and-routability-optimization) | Design Automation Conference · **DAC** | not found | abstract |
| 2025 | [PCBAgent: An Agent-Based Framework for High-Density Printed Circuit Board Placement](#pcbagent-an-agent-based-framework-for-high-density-printed-circuit-board-placement) | ASP-DAC 2025 · **ASP-DAC** | not found | full-text |
| 2024 | [A Comprehensive Study of Open-Source Printed Circuit Board (PCB) Design Software Bugs](#a-comprehensive-study-of-open-source-printed-circuit-board-pcb-design-software-bugs) | IEEE Transactions on Instrumentation and Measurement | announced/unverified | abstract |
| 2024 | [A Study on Alternative Micro-gripper for Intelligent Dissimilar Component Placement-machine in Industrial PCB Manufacturing](#a-study-on-alternative-micro-gripper-for-intelligent-dissimilar-component-placement-machine-in-industrial-pcb-manufacturing) | Journal of the Korea Academia-Industrial cooperation Society | not found | abstract |
| 2024 | [AI-Optimized Placement and Routing for PCB Design](#ai-optimized-placement-and-routing-for-pcb-design) | 2024 Ninth International Conference on Science Technology Engineering and Mathematics (ICONSTEM) | not found | abstract |
| 2024 | [Automatic Multi-Constraint Placement of Printed Circuit Board](#automatic-multi-constraint-placement-of-printed-circuit-board) | International Conference on Communications, Circuits and Systems | not found | abstract |
| 2024 | [Automatic Placement of PCB Functional Modules Based on Regional Division](#automatic-placement-of-pcb-functional-modules-based-on-regional-division) | International Conference on Communications, Circuits and Systems | not found | abstract |
| 2024 | [Late Breaking Results: Modern Automatic PCB Placement with Complex Constraints](#late-breaking-results-modern-automatic-pcb-placement-with-complex-constraints) | Design Automation Conference · **DAC** | not found | abstract |
| 2024 | [Subgraph Matching with Diversity Handling and Its Applications to PCB Placement](#subgraph-matching-with-diversity-handling-and-its-applications-to-pcb-placement) | 2024 2nd International Symposium of Electronics Design Automation (ISEDA) | not found | abstract |
| 2024 | [Subgraph Matching-Based Reference Placement for Printed Circuit Board Designs](#subgraph-matching-based-reference-placement-for-printed-circuit-board-designs) | The Journal of Supercomputing | not found | abstract |
| 2023 | [Substrate Integrated Coaxial Line Millimeterwave Components Manufactured in Standard PCB](#substrate-integrated-coaxial-line-millimeterwave-components-manufactured-in-standard-pcb) | 2023 IEEE 32nd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2022 | [Net Separation-Oriented Printed Circuit Board Placement via Margin Maximization](#net-separation-oriented-printed-circuit-board-placement-via-margin-maximization) | ASP-DAC 2022 · **ASP-DAC** | not found | abstract |
| 2022 | [Subgraph matching based reference placement for PCB designs](#subgraph-matching-based-reference-placement-for-pcb-designs) | Proceedings of the 59th ACM/IEEE Design Automation Conference · **DAC** | not reported | metadata-only |
| 2000 | [An optimization method for placement of decoupling capacitors on printed circuit board](#an-optimization-method-for-placement-of-decoupling-capacitors-on-printed-circuit-board) | IEEE 9th Topical Meeting on Electrical Performance of Electronic Packaging (Cat. No.00TH8524) · **EPEPS** | not found | metadata-only |
| 1997 | [VLSI/PCB placement with obstacles based on sequence-pair](#vlsipcb-placement-with-obstacles-based-on-sequence-pair) | ACM International Symposium on Physical Design · **ISPD** | not found | metadata-only |
| 1987 | [A rule-based placement system for printed wiring boards](#a-rule-based-placement-system-for-printed-wiring-boards) | 24th ACM/IEEE conference proceedings on Design automation conference  - DAC '87 · **DAC** | not reported | metadata-only |
| 1985 | [Knowledge-Based Placement Technique for Printed Wiring Boards](#knowledge-based-placement-technique-for-printed-wiring-boards) | 22nd ACM/IEEE Design Automation Conference · **DAC** | not reported | metadata-only |
| 1979 | [An Interactive Layout System of Analog Printed Wiring Boards](#an-interactive-layout-system-of-analog-printed-wiring-boards) | 16th Design Automation Conference · **DAC** | not reported | metadata-only |
| 1978 | [An Approach to Gate Assignment and Module Placement for Printed Wiring Boards](#an-approach-to-gate-assignment-and-module-placement-for-printed-wiring-boards) | 15th Design Automation Conference · **DAC** | not reported | metadata-only |
| 1968 | [Building block programs for the layout of printed circuit boards utilizing integrated circuit packs (DAPSYS V.2)](#building-block-programs-for-the-layout-of-printed-circuit-boards-utilizing-integrated-circuit-packs-dapsys-v2) | Proceedings of the fifth annual 1968 design automation workshop on Design automation  - DAC '68 · **DAC** | not reported | metadata-only |
...
- **Dataset or data source:** [partial_open](https://www.omnieda.com/): [OmniLayout](https://www.omnieda.com/)
...
- **Dataset or data source:** [open](https://github.com/NVlabs/Cypress): [Cypress benchmarks](https://github.com/NVlabs/Cypress)
