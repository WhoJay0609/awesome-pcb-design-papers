...
- **Metadata:** 2026 · International Conference on Agents and Artificial Intelligence · Mustafa Yasin Erten · [paper](https://doi.org/10.5220/0013856700004052)
- **Scope and topics:** `pcb-core` · `thermal-reliability`, `dfm-manufacturing`, `testing-inspection`, `ai-eda`
...
- **Application scenario:** DFM and assembly optimization.
...
- **Metadata:** 2026 · Journal of Engineering Science and Technology Review · Shengran Pan, Lingfu Kong · [paper](https://doi.org/10.25103/jestr.192.24)
...
- **Metadata:** 2026 · Processes · Li Wang, Ouyang Liu, Huiying Weng, Xiang Chen, Anna Wang, Kexin Zhang · [paper](https://doi.org/10.3390/pr14020227)
- **Scope and topics:** `pcb-core` · `thermal-reliability`, `dfm-manufacturing`, `benchmarks-tools`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
...
- **Metadata:** 2025 · IEEE Access · Qin Ling, Cui Kai, Wenyuan Zhang · [paper](https://doi.org/10.1109/access.2025.3629085)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`, `testing-inspection`, `ai-eda`
...
- **Metadata:** 2025 · Soldering & Surface Mount Technology · Chuno-Chuan Lin, Tsung-Nan Tsai · [paper](https://doi.org/10.1108/SSMT-05-2025-0024)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`, `ai-eda`
- **Code:** not_found: No public implementation was verified.
- **Dataset or data source:** `industrial_process_data`: SMT stencil-printing production data
- **Application scenario:** Multi-quality-characteristic process optimization for SMT stencil printing.
...
- **Metadata:** 2024 · Sustainability · Jaeseok Jang, Qing Tang, Hail Jung · [paper](https://doi.org/10.3390/su162310417)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`, `testing-inspection`, `benchmarks-tools`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `reported_in_abstract`: The abstract mentions a dataset, benchmark, or real, industrial, or simulated data; only names that can be identified are retained.
- **Application scenario:** DFM and assembly optimization.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
...
- **Metadata:** 2024 · Bulletin of Electrical Engineering and Informatics · Nikolay Petkov, Malinka Ivanova · [paper](https://doi.org/10.11591/eei.v13i4.7601)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`, `testing-inspection`, `benchmarks-tools`, `ai-eda`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** DFM and assembly optimization.
- **Problem addressed:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
...
- **Metadata:** 2024 · Electronics · Mateusz Łyczek, Wojciech Skarka · [paper](https://doi.org/10.3390/electronics13071255)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`
- **Code:** not_found: No verified public code repository was found.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
- **Application scenario:** DFM and assembly optimization.
- **Problem addressed:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not report this field.
...
- **Metadata:** 2024 · Journal of Manufacturing and Materials Processing · G. Fontana, Maurizio Calabrese, L. Agnusdei, G. Papadia, Antonio Del Prete · [paper](https://doi.org/10.3390/jmmp8030117)
- **Scope and topics:** `pcb-core` · `thermal-reliability`, `dfm-manufacturing`, `testing-inspection`, `benchmarks-tools`
- **Code:** announced_or_mentioned_unverified: The abstract mentions an open resource, but no direct code URL was verified.
- **Dataset or data source:** `reported_in_abstract`: SolDef_AI
- **Application scenario:** DFM and assembly optimization.
- **Problem addressed:** `reported_in_abstract`: The abstract describes the PCB design problem.
- **Final evaluation:** `reported_in_abstract`: The abstract reports an experiment or evaluation; the metric field lists only items explicitly mentioned in the abstract. Metrics: not explicitly listed in the accessible sources.
- **Baselines:** `not_reported_in_accessible_source`: The accessible metadata or abstract does not list a baseline.
...
- **Metadata:** 2014 · 2014 IEEE 64th Electronic Components and Technology Conference (ECTC) · Jack Ou, Alberto Maldonado, Chio Saephan, Farid Farahmand, Michael Caggiano · [paper](https://doi.org/10.1109/ectc.2014.6897601)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`
...
- **Metadata:** 2011 · 16th Asia and South Pacific Design Automation Conference (ASP-DAC 2011) · Hongxia Fang, Zhiyuan Wang, Xinli Gu, Krishnendu Chakrabarty · [paper](https://doi.org/10.1109/aspdac.2011.5722239)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`, `testing-inspection`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
...
- **Metadata:** 2010 · 2010 Proceedings 60th Electronic Components and Technology Conference (ECTC) · Hongtao Ma, Kuo-Chuan Liu, Tae-Kyu Lee, Dong Hyun Kim · [paper](https://doi.org/10.1109/ectc.2010.5490797)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** The title concerns PCB or board-level design, interconnects, package-to-board SI/PI, or manufacturing and testing. This classification is inferred from the title and the ECTC DOI record; it is not treated as an experimental finding.
...
- **Metadata:** 1989 · Proceedings of the 1989 26th ACM/IEEE conference on Design automation conference  - DAC '89 · A. C. Hung, P. M. Reddy, P. J. Hammer · [paper](https://doi.org/10.1145/74382.74459)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`
- **Code:** not_reported_in_accessible_source: The accessible DOI and Crossref metadata do not report a verifiable code repository.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
...
- **Metadata:** 1983 · Design Automation Conference, Proceedings · M. Tervonen, Hannu Lehikoinen, T. Mukari · [paper](https://doi.org/10.1109/dac.1983.1585689)
- **Scope and topics:** `pcb-core` · `dfm-manufacturing`
- **Code:** not_found: No public code repository was found in the sources checked.
- **Dataset or data source:** `not_reported_in_accessible_source`: The accessible DOI and Crossref metadata do not report a dataset or data source.
- **Application scenario:** DFM and assembly optimization.
