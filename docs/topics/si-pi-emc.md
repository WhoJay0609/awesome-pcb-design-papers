...
70 papers are assigned to this primary topic; 90 PCB-core papers carry it as a primary or additional tag. Detailed fields come from `data/papers.json`; `not_reported` means that the accessible evidence does not state the field. Not reported does not mean absent.

## Catalog

| Year | Paper | Venue | Code | Evidence |
|---:|---|---|---|---|
| 2026 | [Complete Flow for PCB Design Consideration and Power/Signal Integrity Analysis Based on Broadband Model of Parasitic Elements](#complete-flow-for-pcb-design-consideration-and-powersignal-integrity-analysis-based-on-broadband-model-of-parasitic-elements) | International Journal of Circuit Theory and Applications 54(2) | not found | full-text |
| 2026 | [Introduction to High-Speed LVDS Twisted Pair Transmission Across PCB and Chiplet RDL Interfaces](#introduction-to-high-speed-lvds-twisted-pair-transmission-across-pcb-and-chiplet-rdl-interfaces) | 2026 IEEE 76th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2026 | [Measurement-Calibrated PCB Material Modeling for Millimeter-Wave Signal Integrity](#measurement-calibrated-pcb-material-modeling-for-millimeter-wave-signal-integrity) | IEEE SPI 2026 | not found | metadata-only |
| 2026 | [ML-Based Surrogate Modeling of Capacitance Matrices in Multiconductor PCB Interconnects](#ml-based-surrogate-modeling-of-capacitance-matrices-in-multiconductor-pcb-interconnects) | IEEE SPI 2026 | not found | metadata-only |
| 2026 | [Optimization of high-speed link PCB design based on signal integrity simulation](#optimization-of-high-speed-link-pcb-design-based-on-signal-integrity-simulation) | International Conference on Electronic Devices and Intelligent Control | not found | abstract |
| 2025 | [A Comprehensive Study of Signal Integrity Challenges and Solutions in High-Speed PCB Design](#a-comprehensive-study-of-signal-integrity-challenges-and-solutions-in-high-speed-pcb-design) | TechRxiv | not found | abstract |
| 2025 | [Design Strategies for Skew Compensation in Highspeed PCB Strip Line Interconnects](#design-strategies-for-skew-compensation-in-highspeed-pcb-strip-line-interconnects) | IEEE EMC+SIPI 2025 | not found | abstract |
| 2025 | [Manufacturing Challenges and Signal Integrity Considerations in High-Speed Rigid-Flex PCB Design](#manufacturing-challenges-and-signal-integrity-considerations-in-high-speed-rigid-flex-pcb-design) | International Conference on Advances in Cybersecurity | not found | abstract |
| 2025 | [Multi-layer PCB design for mixed-signal systems using altium designer and signal integrity analysis](#multi-layer-pcb-design-for-mixed-signal-systems-using-altium-designer-and-signal-integrity-analysis) | International Journal of Electronics and Microcircuits | not found | metadata-only |
| 2025 | [Separate-Cavity Optimization Method for PCIe Gen6.0 PCB-Connector Pad Design Using Particle Swarm Optimization (PSO) Algorithm](#separate-cavity-optimization-method-for-pcie-gen60-pcb-connector-pad-design-using-particle-swarm-optimization-pso-algorithm) | 2025 IEEE 34th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2025 | [Warpage-Induced Signal Integrity Degradation in High-Speed PCB: A Multi-Domain Analysis and Design Framework](#warpage-induced-signal-integrity-degradation-in-high-speed-pcb-a-multi-domain-analysis-and-design-framework) | Impact | not found | abstract |
| 2024 | [An Efficient SPICE-compatible Model for Fast Co-simulation of Signal and Power Integrity on Multilayer PCB with Arbitrary Shape](#an-efficient-spice-compatible-model-for-fast-co-simulation-of-signal-and-power-integrity-on-multilayer-pcb-with-arbitrary-shape) | 2024 IEEE 33rd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2024 | [Application of Gaussian Process Regression for Data Efficient Prediction of PCB-Based Power Delivery Network Impedance Features](#application-of-gaussian-process-regression-for-data-efficient-prediction-of-pcb-based-power-delivery-network-impedance-features) | IEEE SPI 2024 | not found | abstract |
| 2024 | [Impact of Geometrical and Surface Defects on Signal Integrity of Pcb Copper Traces](#impact-of-geometrical-and-surface-defects-on-signal-integrity-of-pcb-copper-traces) | SSRN | not found | metadata-only |
| 2024 | [Iterative Placement of Decoupling Capacitors using Optimization Algorithms and Machine Learning](#iterative-placement-of-decoupling-capacitors-using-optimization-algorithms-and-machine-learning) | Advances in Radio Science | not found | full-text |
| 2024 | [Models and Methods for the Analysis of PCB Crosstalk in Switch-Mode Power Supplies](#models-and-methods-for-the-analysis-of-pcb-crosstalk-in-switch-mode-power-supplies) | IEEE SPI 2024 | not found | abstract |
| 2024 | [Operator Inference for Rigid-Flex Printed Circuit Boards Subject to Large Deformations](#operator-inference-for-rigid-flex-printed-circuit-boards-subject-to-large-deformations) | 2024 IEEE 33rd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2024 | [PCB Based Power Delivery Network Analysis Using Transfer Learning and Artificial Neural Networks](#pcb-based-power-delivery-network-analysis-using-transfer-learning-and-artificial-neural-networks) | IEEE SPI 2024 | not found | abstract |
| 2024 | [Sensitivity analysis framework for PCB EMC and signal integrity](#sensitivity-analysis-framework-for-pcb-emc-and-signal-integrity) | Proceedings of the 4th URSI Atlantic RadioScience Conference – AT-RASC 2024 | not found | metadata-only |
| 2024 | [Simulation Method for Quasi-Static Solver to Effectively Model Parasitic Components Between Package and PCB](#simulation-method-for-quasi-static-solver-to-effectively-model-parasitic-components-between-package-and-pcb) | EPEPS 2024 · **EPEPS** | not found | full-text |
| 2023 | [An Additive Approach to Embed Chips in a Metallic Matrix Infused PCB](#an-additive-approach-to-embed-chips-in-a-metallic-matrix-infused-pcb) | 2023 IEEE 73rd Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2023 | [Machine Learning Based PCB/Package Stack-up Optimization for Signal Integrity](#machine-learning-based-pcbpackage-stack-up-optimization-for-signal-integrity) | 2023 IEEE 73rd Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2023 | [PCB-level Jitter Sensitivity Measurement and Hierarchical PDN-Z based PSIJ Estimation for PCIe Gen5 SSD](#pcb-level-jitter-sensitivity-measurement-and-hierarchical-pdn-z-based-psij-estimation-for-pcie-gen5-ssd) | 2023 IEEE 32nd Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2023 | [Signal Integrity Design of PCB Transmission Paths using a Decision Tree Approach](#signal-integrity-design-of-pcb-transmission-paths-using-a-decision-tree-approach) | EMC Europe 2023 | not found | full-text |
| 2022 | [Influence of Prepreg Material Properties on Printed Circuit Board (PCB) Stack-up](#influence-of-prepreg-material-properties-on-printed-circuit-board-pcb-stack-up) | 2022 IEEE 72nd Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2022 | [Methods of Printing Copper for PCB Repair](#methods-of-printing-copper-for-pcb-repair) | 2022 IEEE 72nd Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2022 | [Parametric S-Parameters for PCB based Power Delivery Network Design Using Machine Learning](#parametric-s-parameters-for-pcb-based-power-delivery-network-design-using-machine-learning) | IEEE SPI 2022 | not found | abstract |
| 2022 | [Printed Circuit Board Electromagnetic Compatibility Design of LLC Resonant Converter Based on Field-Line Coupling Effect](#printed-circuit-board-electromagnetic-compatibility-design-of-llc-resonant-converter-based-on-field-line-coupling-effect) | Journal of Nanoelectronics and Optoelectronics | not found | abstract |
| 2021 | [Au-Less, Ni-Less & Roughness-Less PCB Cu Surface Treatment Using All-in-One Al2O3 Passivation](#au-less-ni-less--roughness-less-pcb-cu-surface-treatment-using-all-in-one-al2o3-passivation) | 2021 IEEE 71st Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2021 | [Distributed Nonlinear Shielding in Power Delivery Networks on Printed Circuit Boards](#distributed-nonlinear-shielding-in-power-delivery-networks-on-printed-circuit-boards) | 2021 IEEE 30th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2021 | [Evaluation of Support Vector Machines for PCB based Power Delivery Network Classification](#evaluation-of-support-vector-machines-for-pcb-based-power-delivery-network-classification) | EPEPS 2021 · **EPEPS** | not found | abstract |
| 2021 | [Flexible Connectors and PCB Segmentation for Signaling and Power Delivery in Wafer-Scale Systems](#flexible-connectors-and-pcb-segmentation-for-signaling-and-power-delivery-in-wafer-scale-systems) | 2021 IEEE 71st Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2021 | [Study on EMI Shielding at the PCB Strip Level with Conformal Spray Coating Process](#study-on-emi-shielding-at-the-pcb-strip-level-with-conformal-spray-coating-process) | 2021 IEEE 71st Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2020 | [Cost-Effective Implementation of Air-Filled Waveguides on Printed Circuit Boards](#cost-effective-implementation-of-air-filled-waveguides-on-printed-circuit-boards) | 2020 IEEE 29th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2020 | [Stripline-Slotline Rectangular Resonators for Measurement of Uniaxial Anisotropic Permittivity of Composite PCB Dielectric Material](#stripline-slotline-rectangular-resonators-for-measurement-of-uniaxial-anisotropic-permittivity-of-composite-pcb-dielectric-material) | 2020 IEEE 70th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2019 | [Fast and Accurate Radiation Calculations for Printed Circuit Boards and Packages](#fast-and-accurate-radiation-calculations-for-printed-circuit-boards-and-packages) | 2019 IEEE 28th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2019 | [Novel Multicore PCB and Substrate Solutions for Ultra Broadband Dual Polarized Antennas for 5G Millimeter Wave Covering 28GHz & 39GHz Range](#novel-multicore-pcb-and-substrate-solutions-for-ultra-broadband-dual-polarized-antennas-for-5g-millimeter-wave-covering-28ghz--39ghz-range) | 2019 IEEE 69th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2019 | [PCB Microstrip Line Far-End Crosstalk Mitigation by Surface Mount Capacitors](#pcb-microstrip-line-far-end-crosstalk-mitigation-by-surface-mount-capacitors) | 2019 IEEE 69th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2019 | [Signal Integrity Considerations of PCB Wiring in Tightly Pitched Module Pin Fields of High Speed Channels](#signal-integrity-considerations-of-pcb-wiring-in-tightly-pitched-module-pin-fields-of-high-speed-channels) | 2019 IEEE 28th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2018 | [Experimentally Minimizing the Gap Distance Between Extra Tall Packages and PCB Using the Digital Image Correlation (DIC) Method](#experimentally-minimizing-the-gap-distance-between-extra-tall-packages-and-pcb-using-the-digital-image-correlation-dic-method) | 2018 IEEE 68th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2018 | [Fast chip-package-PCB coanalysis methodology for power integrity of multi-domain high-speed memory: A case study](#fast-chip-package-pcb-coanalysis-methodology-for-power-integrity-of-multi-domain-high-speed-memory-a-case-study) | Design, Automation and Test in Europe · **DATE** | not found | metadata-only |
| 2018 | [High Power-Density 3D Integrated Power Supply Module Based on Panel-Level PCB Embedded Technology](#high-power-density-3d-integrated-power-supply-module-based-on-panel-level-pcb-embedded-technology) | 2018 IEEE 68th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2018 | [Vertical and Horizontal Transitions of Substrate Integrated Waveguides Within a Multi-Layered PCB for High Speed Signaling Applications](#vertical-and-horizontal-transitions-of-substrate-integrated-waveguides-within-a-multi-layered-pcb-for-high-speed-signaling-applications) | 2018 IEEE 27th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2017 | [Comparison and Consistency of On-PCB Microstrip Line Modeling by 3D Fullwave and 2D Quasi-Static Approaches for High Speed Packaging System Signal Integrity Simulations](#comparison-and-consistency-of-on-pcb-microstrip-line-modeling-by-3d-fullwave-and-2d-quasi-static-approaches-for-high-speed-packaging-system-signal-integrity-simulations) | 2017 IEEE 67th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2017 | [Embeded filtering in PCB integrated ultra high speed dielectric waveguides using photonic band gap structures](#embeded-filtering-in-pcb-integrated-ultra-high-speed-dielectric-waveguides-using-photonic-band-gap-structures) | 2017 IEEE 26th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2017 | [Signal Integrity Modeling in Inhomogeneous Waveguide/PCB of Arbitrary Shape Using Broadband Green's Function](#signal-integrity-modeling-in-inhomogeneous-waveguidepcb-of-arbitrary-shape-using-broadband-greens-function) | 2017 IEEE 67th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2017 | [The accuracy of port connections between layers in printed circuit board](#the-accuracy-of-port-connections-between-layers-in-printed-circuit-board) | 2017 IEEE 26th Conference on Electrical Performance of Electronic Packaging and Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2016 | [A dielectric based waveguide integrated in a multilayer PCB for ultra high speed communications](#a-dielectric-based-waveguide-integrated-in-a-multilayer-pcb-for-ultra-high-speed-communications) | 2016 IEEE 25th Conference on Electrical Performance Of Electronic Packaging And Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2016 | [A method to assess the radiated susceptibility of printed circuit boards](#a-method-to-assess-the-radiated-susceptibility-of-printed-circuit-boards) | 2016 IEEE 25th Conference on Electrical Performance Of Electronic Packaging And Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2016 | [A neural network based method for predicting PCB glass weave induced skew](#a-neural-network-based-method-for-predicting-pcb-glass-weave-induced-skew) | 2016 IEEE 25th Conference on Electrical Performance Of Electronic Packaging And Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2016 | [Crosstalk evaluation between ultra high speed multi-layer compatible PCB dielectric waveguides and reduction using split ring resonators](#crosstalk-evaluation-between-ultra-high-speed-multi-layer-compatible-pcb-dielectric-waveguides-and-reduction-using-split-ring-resonators) | 2016 IEEE 25th Conference on Electrical Performance Of Electronic Packaging And Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2016 | [PCB stack-up design and optimization for next generation speeds](#pcb-stack-up-design-and-optimization-for-next-generation-speeds) | 2016 IEEE 25th Conference on Electrical Performance Of Electronic Packaging And Systems (EPEPS) · **EPEPS** | not reported | metadata-only |
| 2015 | [Effects of board design parameters on failure mechanisms of PCB/BGA assemblies under drop impact](#effects-of-board-design-parameters-on-failure-mechanisms-of-pcbbga-assemblies-under-drop-impact) | 2015 IEEE 65th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2015 | [Impact of PCB decoupling on device electromigration performance](#impact-of-pcb-decoupling-on-device-electromigration-performance) | 2015 IEEE 65th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2014 | [Improving the target impedance method for PCB decoupling of core power](#improving-the-target-impedance-method-for-pcb-decoupling-of-core-power) | 2014 IEEE 64th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2013 | [Fast signal integrity methodology for PCB pre-layout analysis and layout quality check](#fast-signal-integrity-methodology-for-pcb-pre-layout-analysis-and-layout-quality-check) | 2013 IEEE 63rd Electronic Components and Technology Conference · **ECTC** | not found | metadata-only |
| 2011 | [Method for early detection of PCB bending induced pad cratering](#method-for-early-detection-of-pcb-bending-induced-pad-cratering) | 2011 IEEE 61st Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2011 | [Verification of novel technology for power integrity on 16-channel 3Gbps circuit boards](#verification-of-novel-technology-for-power-integrity-on-16-channel-3gbps-circuit-boards) | 2011 IEEE 20th Conference on Electrical Performance of Electronic Packaging and Systems · **EPEPS** | not reported | metadata-only |
| 2010 | [A compact, low-cost, and wide-band passive equalizer design using multi-layer PCB parasitics](#a-compact-low-cost-and-wide-band-passive-equalizer-design-using-multi-layer-pcb-parasitics) | 19th Topical Meeting on Electrical Performance of Electronic Packaging and Systems · **EPEPS** | not reported | metadata-only |
| 2010 | [Failure mechanism and mitigation of PCB pad cratering](#failure-mechanism-and-mitigation-of-pcb-pad-cratering) | 2010 Proceedings 60th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2010 | [Layer misregistration in PCB and its effects on signal propagation](#layer-misregistration-in-pcb-and-its-effects-on-signal-propagation) | 2010 Proceedings 60th Electronic Components and Technology Conference (ECTC) · **ECTC** | not reported | metadata-only |
| 2009 | [An approach for quantifying the conductor and dielectric losses in PCB transmission lines](#an-approach-for-quantifying-the-conductor-and-dielectric-losses-in-pcb-transmission-lines) | 2009 IEEE 18th Conference on Electrical Performance of Electronic Packaging and Systems · **EPEPS** | not reported | metadata-only |
| 2008 | [Analysis of noise coupling from printed circuit board to shielding enclosure](#analysis-of-noise-coupling-from-printed-circuit-board-to-shielding-enclosure) | 2008 IEEE-EPEP Electrical Performance of Electronic Packaging · **EPEPS** | not reported | metadata-only |
| 2007 | [Electrical Analysis of Multi-board PCB Systems with Differential Signaling Considering Non-ideal Common Ground Connection](#electrical-analysis-of-multi-board-pcb-systems-with-differential-signaling-considering-non-ideal-common-ground-connection) | 2007 IEEE Electrical Performance of Electronic Packaging · **EPEPS** | not reported | metadata-only |
| 2007 | [Jitter Amplification Considerations for PCB Clock Channel Design](#jitter-amplification-considerations-for-pcb-clock-channel-design) | 2007 IEEE Electrical Performance of Electronic Packaging · **EPEPS** | not reported | metadata-only |
| 1998 | [A unified technique for PCB/MCM design by combining electromagnetic field analysis with circuit simulator](#a-unified-technique-for-pcbmcm-design-by-combining-electromagnetic-field-analysis-with-circuit-simulator) | Proceedings Design, Automation and Test in Europe · **DATE** | not found | metadata-only |
| 1998 | [Development of a support tool for PCB design with EMC constraint. Reflection and crosstalk noise reduction in manual design](#development-of-a-support-tool-for-pcb-design-with-emc-constraint-reflection-and-crosstalk-noise-reduction-in-manual-design) | Proceedings of 1998 Asia and South Pacific Design Automation Conference · **ASP-DAC** | not found | metadata-only |
| 1998 | [Electromagnetic modeling and signal integrity simulation of power/ground networks in high speed digital packages and printed circuit boards](#electromagnetic-modeling-and-signal-integrity-simulation-of-powerground-networks-in-high-speed-digital-packages-and-printed-circuit-boards) | Proceedings of the 35th annual conference on Design automation conference  - DAC '98 · **DAC** | not reported | metadata-only |
| 1996 | [Signal integrity analysis of simultaneous switching noises and decoupling capacitors in digital packages and PCB systems](#signal-integrity-analysis-of-simultaneous-switching-noises-and-decoupling-capacitors-in-digital-packages-and-pcb-systems) | Electrical Performance of Electronic Packaging · **EPEPS** | not found | metadata-only |
| 1993 | [Evaluation of ground inductance in printed circuit boards](#evaluation-of-ground-inductance-in-printed-circuit-boards) | Proceedings of IEEE Electrical Performance of Electronic Packaging · **EPEPS** | not reported | metadata-only |
...
- **Dataset or data source:** [controlled_access](https://www.tet.tuhh.de/si-pi-database-de/): [SI/PI-Database](https://www.tet.tuhh.de/si-pi-database-de/), [10,000 simulations](https://www.tet.tuhh.de/si-pi-database-de/)
